...
if [ $(uname) == "Darwin" ]; then
  ...
  sudo apt install neovim git zsh curl tmux build-essential rbenv virtualenv openjdk-15-dbg openjdk-15-doc openjdk-15-jdk openjdk-15-jre fd-find bat hexyl jq ripgrep tidy
